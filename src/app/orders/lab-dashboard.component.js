...
LaboratoryDashboardComponent = __decorate([
    core_1.Component({
        // selector: 'my-app',
        templateUrl: 'app/orders/lab-dashboard.component.html',
        styleUrls: ['app/orders/lab-dashboard.component.css']
    })
], LaboratoryDashboardComponent);
exports.LaboratoryDashboardComponent = LaboratoryDashboardComponent;
