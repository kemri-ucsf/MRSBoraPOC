...
describe('Model: Encounter', function () {
    var existingEncounter = {
        uuid: 'uuid',
    ...
    it('should wrap openmrs encounter for display correctly', function () {
        var wrappedEnconter = new encounter_model_1.Encounter(existingEncounter);
    ...
    it('should generate a new encounters new payload correctly', function () {
        var wrappedEnconter = new encounter_model_1.Encounter(existingEncounter);
        var newPayload = wrappedEnconter.toNewPayload();
    ...
    it('should generate an existing encounters payload correctly', function () {
        var wrappedEnconter = new encounter_model_1.Encounter(existingEncounter);
        var newPayload = wrappedEnconter.toUpdatePayload();
...
//# sourceMappingURL=encounter.model.spec.js.map